...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Documentation.UsersPermissionsUser();
  });
  ...
  describe('UsersPermissionsUser', function() {
    it('should create an instance of UsersPermissionsUser', function() {
      // uncomment below and update the code to test UsersPermissionsUser
      //var instance = new Documentation.UsersPermissionsUser();
      //expect(instance).to.be.a(Documentation.UsersPermissionsUser);
    });
